...
import AdminImport from "@/pages/attendance/AdminImport.tsx";
...
import FixLabRecords from "@/pages/admin/FixLabRecords.tsx";
      ...
      <ConvexAuthProvider client={convex}>
        <BrowserRouter>
          ...
          <Routes>
            ...
            <Route path="/admin/fix-lab-records" element={<FixLabRecords />} />
